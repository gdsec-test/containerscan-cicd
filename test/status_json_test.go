...
func Test_Withstatus_JSON_HappyPath(t *testing.T) {
	var valid bool
	var msg string
	...
	if valid, msg := assertDebugMessageContains(jo.DebugMessages, "with GitHub"); !valid {
		t.Error(msg)
	}
	...
	if valid, msg = assertDebugMessageContains(jo.DebugMessages, "Reporting success to GitHub"); !valid {
		t.Error(msg)
	}
...
func Test_Withstatus_JSON_HappyPath_With_Unsupported_Env_AWS_DEFAULT_REGION(t *testing.T) {
	var valid bool
	var msg string
...
func Test_Withstatus_JSON_ErrorPath_Without_Env_AWS_ACCESS_KEY_ID_And_AWS_SESSION_TOKEN(t *testing.T) {
	var valid bool
	var msg string
...
func Test_Withstatus_JSON_ErrorPath_Without_Env_CONTAINER(t *testing.T) {
	var valid bool
	var msg string
...
// func Test_Withstatus_JSON_ErrorPath_Without_GITHUB_REPO_And_COMMIT_SHA(t *testing.T) {
// 	var valid bool
// 	var msg string
...
func Test_Withstatus_JSON_ErrorPath_With_Invalid_Env_AWS_SECRET_ACCESS_KEY(t *testing.T) {
	var valid bool
	var msg string
...
func Test_Withstatus_JSON_SadPath(t *testing.T) {
	var valid bool
	var msg string
	...
	if valid, msg = assertDebugMessageContains(jo.DebugMessages, "Reporting failure to GitHub"); !valid {
		t.Error(msg)
	}
